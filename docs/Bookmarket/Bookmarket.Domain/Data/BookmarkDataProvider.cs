...
namespace Bookmarket.Domain.Data
{
    ...
    public class BookmarkDataProvider : IBookmarkDataProvider
    {
        ...
        private List<Bookmark>? ReadFromFile()
        {
            ...
            {
                new Bookmark{Id=21, Title= "Blog Pirate", Href="https://www.google.com/" },
                new Bookmark{Id=22, Title= "Blog Arr", Href="https://www.google.com/" },
                new Bookmark{Id=23, Title= "Chest Blog", Href="https://www.google.com/" },
                new Bookmark{Id=24, Title= "Treasure Blog", Href="https://www.google.com/" },
                new Bookmark{Id=25, Title= "Avast", Href="https://www.google.com/" },
                new Bookmark{Id=26, Title= "Shiver me Timbers", Href="https://www.google.com/" },
                new Bookmark{Id=26, Title= "Shiver me Timbers", Href="https://www.google.com/" },
                new Bookmark{Id=26, Title= "Shiver me Timbers", Href="https://www.google.com/" },
                new Bookmark{Id=26, Title= "Shiver me Timbers", Href="https://www.google.com/" },
                new Bookmark{Id=26, Title= "Shiver me Timbers", Href="https://www.google.com/" },
